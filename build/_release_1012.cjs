// 发布 v1.0.12 Release：创建 release → 上传 EXE + version.json
const fs = require('fs');
...
(async () => {
  ...
  const assets = [
    { file: path.join(root, 'GZInspection_v1.0.12.exe'), name: 'GZInspection_v1.0.12.exe', type: 'application/octet-stream' },
